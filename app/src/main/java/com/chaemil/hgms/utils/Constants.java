...
public class Constants {
    ...
    public static final String JSON_POST_UTF8 = "UTF-8";

    public static final String HTTPS = "https://";
    public static final String DOMAIN = "oaza.tv/";
    public static final String API = HTTPS + DOMAIN + "api/v2/";
    ...
    public static final String JSON_ORIGINAL_FILE = "original_file";
