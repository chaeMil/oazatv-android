...
public class SectionPopularVideos extends StatelessSection {
    ...
    public SectionPopularVideos(Context context, MainActivity mainActivity, ArrayList<ArchiveItem> archive) {
        super(R.layout.homepage_section_header, R.layout.featured_item);
